...
if($listCounter==1){
    $query="DELETE FROM logic_autos WHERE project_id=".$arrayproject_id[0];
...
for ($i = 0; $i < sizeof($arrayproject_id); $i++) {
    ...
    $sql = "INSERT INTO `logic_autos`(`project_id`, `logic_id`, `qid`, `logic_type_id`, `if_condition`, `then_value`, `else_value`) 
