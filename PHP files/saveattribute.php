...
if (isset($_POST['link_id1'])) {
    $arraylink_id1 = $_POST['link_id1'];
}
if (isset($_POST['link_id2'])) {
    $arraylink_id2 = $_POST['link_id2'];
}
...
if (isset($_POST['group_name'])) {
    $arraygroup_name = $_POST['group_name'];
}
if (isset($_POST['filter_qid'])) {
    $arrayfilter_qid = $_POST['filter_qid'];
}
if (isset($_POST['filter_type'])) {
    $arrayfilter_type = $_POST['filter_type'];
}
if (isset($_POST['excep_value'])) {
    $arrayexcep_value = $_POST['excep_value'];
}
...
if($listCounter==1){
    $query="DELETE FROM attributes WHERE project_id=".$arrayproject_id[0];
...
for ($i = 0; $i < sizeof($arrayproject_id); $i++) {
    ...
    $sql = "INSERT INTO `attributes`(`project_id`, `qid`, `attribute_english`, `attribute_bengali`, `attribute_value`, `attribute_order`, `take_openended`, `is_exclusive`, `link_id1`, `link_id2`, `min_value`, `max_value`, `force_and_msg_opt`, `group_name`, `filter_qid`, `filter_type`, `excep_value`, `comments`, `attribute_lang3`, `attribute_lang4`, `attribute_lang5`, `attribute_lang6`, `attribute_lang7`, `attribute_lang8`, `attribute_lang9`, `attribute_lang10`) 
            VALUES (".$arrayproject_id[$i].",'".$arrayqid[$i]."','".$arrayattribute_english[$i]."','".$arrayattribute_bengali[$i]."','".$arrayqattribute_value[$i]."',".$arrayqattribute_order[$i].",'".$arrayrtake_openended[$i]."','".$arrayis_exclusive[$i]."','".$arraylink_id1[$i]."','".$arraylink_id2[$i]."','".$arraymin_value[$i]."','".$arraymax_value[$i]."','".$arrayforce_and_msg_opt[$i]."','".$arraygroup_name[$i]."','".$arrayfilter_qid[$i]."','".$arrayfilter_type[$i]."','".$arrayexcep_value[$i]."','".$arraycomments[$i]."','".$arrayattribute_lang3[$i]."','".$arrayattribute_lang4[$i]."','".$arrayattribute_lang5[$i]."','".$arrayattribute_lang6[$i]."','".$arrayattribute_lang7[$i]."','".$arrayattribute_lang8[$i]."','".$arrayattribute_lang9[$i]."','".$arrayattribute_lang10[$i]."');";
